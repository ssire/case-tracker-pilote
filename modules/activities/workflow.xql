...
import module namespace activity = "http://oppidoc.com/ns/xcm/activity" at "../activities/activity.xqm";
    ...
    <Display ResourceNo="{$activity-no}" Mode="workflow">
      <Cartouche>
        ...
        <Title LinkToCase="{ $case/No }">
          ...
          custom:gen-activity-title($case, $activity, $lang)
          }
        </Title>
      </Cartouche>
      ...
      <Tabs>
        ...
        { workflow:gen-activities-tab($case, $activity, activity:gen-activities-for-case($case, $lang), $lang) }
